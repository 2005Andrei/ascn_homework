...
#text[
  ...
  hipercuburi ca fiind spate in spate, astfel gruparile se fac si spate-spate. Pentru obtinerea formelor minime conjunctive,
  acestea pot fi obtinute doar in anumite cazuri prin rescrierea formelor disjucntive si dubla negare.
]
...
#text[
  ...
  perechi care diferă printr-o singură variabilă, algoritmul continuând până la identificarea tuturor implicanților primi.
]
